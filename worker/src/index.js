// Sponsir waitlist Worker (Cloudflare).
//
// Routes:
...
const DEFAULT_ORIGINS = ['https://sponsir.app', 'https://www.sponsir.app', 'http://localhost:8897', 'http://127.0.0.1:8897'];
...
async function sendConfirmation(env, email) {
  ...
  const from = env.RESEND_FROM || 'Sponsir <hello@sponsir.app>';
  try {
    await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from,
        to: [email],
        subject: 'You\u2019re on the Sponsir waitlist',
        text: [
          'Thanks for joining the Sponsir waitlist.',
          '',
          'Sponsir is a Gmail extension that verifies sponsorship emails, warns about fake briefs and malware contracts, and pulls out the deal terms \u2014 all in your browser.',
          '',
          ...
          '',
          'Until then, the free Pitch Checker is live: https://sponsir.app/check.html',
          '',
